...
#            |--------------------------------------------------------------------------|
#            | This module contains all the functions needed to plot wave and wind data |
#            | in a rose diagram. The original code is from                             |
#            |                                                                          |
#            |  https://github.com/python-windrose                                      |
#            |                                                                          |
#            | Author: D. Bruciaferri                                                   |
#            | Date and place: 27th Mar 2020, Met Office, United Kindom                 | 
#            |--------------------------------------------------------------------------|
...
class WindroseAxes(PolarAxes):
    ...
    def from_ax(ax=None, fig=None, rmax=None, theta_labels=None, *args, **kwargs):
        ...
        if ax is None:
            ...
            # D.B. added compatibility with older versions of matplotlib
            try:
